    ...
    return (
        <div>
            ...
            <CategorySection className={``} >
                ...
                <ActionButton clicked={menu==='create'} onClick={()=>setMenu('create')}>
                ...
                <ActionButton clicked={menu==='list'} onClick={()=>setMenu('list')}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                         stroke="currentColor" className="m-auto w-6 h-6 mt-2 mb-1">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <ActionButton clicked={menu==='private'} onClick={()=>setMenu('private')}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <ActionButton clicked={menu==='exp'} onClick={()=>setMenu('exp')}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                         stroke="currentColor" className="m-auto w-4 h-4 mt-3 mb-2">
                        <path stroke-linecap="round" stroke-linejoin="round"
